...
import { TodoCreationAttributes, TodoUpdateAttributes } from '@monorepo/shared-types';

const router = Router();

router.get('/health', (req: Request, res: Response) => {
    res.json({ status: 'healthy', app: 'todo-list' });
});

// GET /api/todo-list/todos - Get all todos
...
// GET /api/todo-list/todos/:id - Get a single todo
...
// POST /api/todo-list/todos - Create a new todo
...
// PUT /api/todo-list/todos/:id - Update a todo
...
// DELETE /api/todo-list/todos/:id - Delete a todo
